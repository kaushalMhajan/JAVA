...
<body style="font-family: cursive;">
	...
	<div style="margin: auto; width: 25%;margin-top: 50px;font-size: larger;font-weight: bold;">Welcome to Simple
		Interest Calulator</div>
	<br>
	<div style="margin: auto;width: 25%;">
		<form method="post">
			<div class="mb-3">
				<label for="exampleInputEmail1" class="form-label">Principle</label>
				<input type="text" class="form-control" id="exampleInputEmail1" name="principle"
